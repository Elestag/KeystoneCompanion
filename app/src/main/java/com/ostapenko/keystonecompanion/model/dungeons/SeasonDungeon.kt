...
sealed class SeasonDungeon(val name: String, val imageResId: Int, val mPlus: Boolean = true) {
    object TheAzureVault :
        SeasonDungeon("The Azure Vault", R.drawable.the_azure_vault_small)

    object AlgetharAcademy :
        SeasonDungeon("Algeth'ar Academy", R.drawable.algethar_academy_small)

    object RubyLifePools :
        SeasonDungeon("Ruby Life Pools", R.drawable.ruby_life_pools_small)

    object TheNokhudOffensive :
        SeasonDungeon("The Nokhud Offensive", R.drawable.the_nokhud_offensive_small)
