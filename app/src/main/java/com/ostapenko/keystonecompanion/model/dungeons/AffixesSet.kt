...
sealed class AffixesSet(val nameResId: Int, val imageResId: Int) {
    ...
    object Afflicted : AffixesSet(R.string.affix_afflicted, R.drawable.affix_afflicted)
    object Incorporeal : AffixesSet(R.string.affix_incorporeal, R.drawable.affix_incorporeal)
    object Entangling : AffixesSet(R.string.affix_entangling, R.drawable.affix_entangling)
    object Shielding : AffixesSet(R.string.affix_shielding, R.drawable.affix_shielding)
